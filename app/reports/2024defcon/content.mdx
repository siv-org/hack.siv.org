...
import {
  ...
  BallotImg,
  BudgetBallotAnimation,
  VoteConfirmationImg,
  PrivacyComparison,
  RLAOptions,
  SIVVoterInterfaceImage,
} from './images'
...
<Byline published="04/23/2025" author="David Ernst & Ariana Ivan" />
...
In the [Detailed Information](#hack-siv-detailed-information) section below, we provide in-depth examinations of the Top Earning Submissions, along with links to all 42 submissions.
...
A few submissions centered on voters sharing how they voted with 3rd parties, for either Vote Selling (carrot) or Voter Coercion (stick). We were quite excited to use this contest as an opportunity to test out a limited version of one of our anti-Vote-Selling solutions, a system based on bounty-rewards we call [The Vote Seller's Dilemma](https://docs.siv.org/research-in-progress/vote-sellers-dilemma). This appeared to work well enough for the $5,000 Public Vote. It did not seem like decisions were significantly compromised by vote selling, and we are excited to run a prize-awarding vote again in the future using a similar format.

We are also working on a new, additional tool against this sort of compromise that would allow SIV votes to achieve a level of receipt-freeness similar to in-person paper voting.
...
<AwardsProcessImage>
  ...
  Criteria](https://hack.siv.org/2024defcon/rules#awarding-prizes).
</AwardsProcessImage>
...
<Testimonial author="Dr. Jason Green" secondLine={<>Cybersecurity and Elections Researcher at <c.a href="https://www.ncat.edu/research/centers/creo/index.php">CREO Lab</c.a></>} thirdLine="North Carolina A&T University">
...
<div className="text-sm italic text-center text-slate-400 my-8">
...
The detailed rules for the HACK SIV contest were published on [HACK SIV contest rules](https://hack.siv.org/2024defcon/rules).
...
For the Public Vote, we also [used one of our anti-vote-selling solutions](https://hack.siv.org/2024defcon/rules#the-vote-buying-elephant-in-the-room), based on game-theory, to disrupt trust between would-be buyers and sellers. Also detailed below under _"How The HACK SIV Contest Was Structured"_ > _"Public Prize Awarding Process"_ > _"Anti-Vote-Selling"_.
...
The vast majority of people we've spoken with — including citizens, candidates, and election officials — do not prioritize risks of vote buying & selling as reasons to reject secure internet voting. (This isn't a rigorous survey, and we don't present it as proof — just context.)

In contrast, some people view it almost axiomatically as a show-stopping problem, despite vote-by-mail ballots already being trivially easy to share with a third-party (in addition to other problems) and in widespread use.
...
<Details title="Can SIV do Post-Election Audits?" readTime={1}>
...
<SecurityProperty
  title="Privacy"
  description="Free & Fair Vote Selection"
  items={[
    'Strong Encryption: end-to-end privacy from election administrators or servers learning individual vote selections',
    "Quick way for voters to airgap voter interface, so it can't secretly exfiltrate private vote selections, without needing to review any source code",
    'Anonymization of vote selections, not voters — like existing vote-by-mail: sealed envelope, private selections inside, outside signed by voter',
    'Protected against network-level de-anonymizations such as IP address or timing correlations',
  ]}
/>
...
<SecurityProperty
  title="Accessibility"
  description="Making it easy for all citizens to participate"
  items={[
    'Easy to use point-and-click voter interface',
    'Available on phones, laptops, & desktops that voters already use countless times per day',
    'No software installation necessary',
    'Supports existing accessibility tools for voters with vision or mobility challenges',
    ...
    'Significant cost-savings for election administrators: 10x less staff, polling locations, equipment, paper, costs',
    'Easier to use advanced spoiler-resistant voting methods, such as Ranked-Choice, Score, Approval, STAR, Participatory Budgeting',
    'Highly resilient in the face of extreme weather events or other disruptions like pandemics',
  ]}
/>

---

<c.h2 customClass="!border-none">Contribute to HACK SIV</c.h2>

### Evaluate The SIV Protocol

We've made the [SIV Protocol](https://docs.siv.org/) and [codebase](https://github.com/siv-org/siv) publicly available, and invite anyone with interest and technical curiosity to learn more about SIV and independently verify our claims.

<div className="text-sm border border-slate-200/70 bg-brown-50 rounded-lg px-4 py-2 my-4 *:flex *:gap-2 *:items-center">
  <ShieldIcon /> Share your findings: [hack@siv.org](mailto:hack@siv.org)
</div>
...
Start here → [hack.siv.org/redvblue](https://hack.siv.org/redvblue)
...
> **For <i className="not-italic text-green-600/90">supporters</i> of digital democracy:**
>
...
> **For <i className="not-italic text-orange-700/60">skeptics</i> with security concerns:**
>
> If you oppose internet voting, contributing to fund more research into vulnerabilities is a powerful way to substantiate your stance and influence the debate.

#### 100% of HACK SIV contributions go to rewarding novel discoveries by independent security researchers.

<div className="text-base italic text-slate-400 my-8">
  Contact us at [hack@siv.org](mailto:hack@siv.org)
</div>

<Quote author="Kerckhoffs' Principle, 1883">
  A system should be secure even if everything about the system, except the key,
  is public knowledge.
</Quote>
